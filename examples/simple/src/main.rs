use secret_keeper::{
    ...
    ciphers::{CipherKind, xchacha20::NONCEBYTES},
    rand,
};

const KEEPER_URI: &str ="env:";
const PLAINTEXT: &[u8] = b"hello world!";
const CIPHER: CipherKind = CipherKind::XChaCha20Poly1305;

/// Sample program demonstrating use of SecretKeeper and Cipher apis.
#[tokio::main]
async fn main() -> Result<(),Error> {
    // set password in environment so the example runs cleanly
    std::env::set_var("VAULT_PASSWORD", "my-secret");
